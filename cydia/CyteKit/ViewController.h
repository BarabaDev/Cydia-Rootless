...
// Whether the bottom tab bar auto-hides while this controller's list is
// scrolled. Default YES. Home and Sources override this to NO so their tab bar
// stays fixed, matching the requested behavior on those two tabs.
